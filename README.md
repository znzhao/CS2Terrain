...
This program takes the height map generated from CS2, and modifies it according to the following procedure:

1. The height map generated by CS2 has a size of $4096\times 4096$. For the reason of program speed, resize the height map to given dimensions.

2. Apply average blur to the height map. This will result in a smoother input height map.

3. Randomly generate the detailed mountain texure height according to the Perlin noise.
